function [results] = trainClassifierNaiveBayes(trainingData, Trains, Tests)
 disp('Bayes Classification')
...
trainedClassifier.ClassificationEnsemble = classificationNaiveBayes;
...
ensemblePredictFcn = @(x) predict(classificationNaiveBayes, x);
