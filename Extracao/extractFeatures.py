...
# File variables
#ROOT = 'D:/PIBIC/2022-2023/CODIGOS/Extracao/'
ROOT = '/mnt/d/PIBIC/2022-2023/CODIGOS/Extracao/'
...
def run(case):
  ...
  try:
    ...
    if os.path.isfile(output_filename):
      ...
      # Extract features
      ptLogger.info(f"Original label: {label} | Picked label: {255 if label == 1 else 0}")
      feature_vector.update(extractor.execute(imageFilepath, maskFilepath, label= 255 if label == 1 else 0), label=label)
